library(CMplot)
# p_smr plot
data1 <- read.table("C:/SMR/SMR_result/FDR/liver_type_2_diabetes.csv", sep = ",", header = TRUE)
data2 <- read.table("C:/SMR/SMR_result/FDR/liver_obesity.csv", sep = ",", header = TRUE)
data3 <- read.table("C:/SMR/SMR_result/FDR/liver_hypertension.csv",sep = ",", header = TRUE)
data4 <- read.table("C:/SMR/SMR_result/FDR/liver_hyperlipidemia.csv",sep = ",", header = TRUE)
data5 <- read.table("C:/SMR/SMR_result/FDR/liver_diabetes.csv",sep = ",", header = TRUE)
data6 <- read.table('C:/SMR/SMR_result/FDR/liver_CAD.csv', sep = ',', header = T)
...
write.table(databind, "C:/SMR/graph/manhatan/liver_manhattan_cad.txt", row.names = FALSE, sep = "\t", quote = FALSE)
...
CMplot(databind, plot.type="m",multraits=TRUE,threshold=c(1e-6,1e-4),threshold.lty=c(1,2), 
       ...
       signal.cex=1, file="pdf",file.name="Liver",dpi=300,file.output=TRUE,verbose=TRUE,
